...
export default function Navbar({ activeTab, onTabChange, bookmarkCount, user, onLogin, onLogout }) {
  ...
  const navBg = scrolled ? 'rgba(4,6,20,0.92)' : 'transparent'
  const navBorder = scrolled ? '1px solid rgba(30,90,180,0.18)' : '1px solid transparent'
        ...
        <button
          ...
          style={{
            ...
            boxShadow: activeTab === tab.key
              ? '0 0 16px rgba(6,182,212,0.25), inset 0 1px 0 rgba(255,255,255,0.08)'
              : 'none',
            whiteSpace: 'nowrap',
          }}
        ...
        >
          <div style={{
            ...
            <div style={{
              ...
              background: 'rgba(255,255,255,0.08)', borderRadius: '10px 10px 0 0',
            }} />
            <span style={{
              fontFamily: "'Space Grotesk', sans-serif",
          ...
          {!isMobile && (
            <>
              <a
                ...
                style={{
                  fontSize: '12px', color: 'rgba(180,210,255,0.45)',
                  textDecoration: 'none',
                ...
                onMouseEnter={e => {
                  ...
                  e.currentTarget.style.background = 'rgba(13,110,253,0.12)'
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.color = 'rgba(180,210,255,0.45)'
                  e.currentTarget.style.borderColor = 'rgba(13,110,253,0.18)'
          ...
          {!authLoading && (
            user ? (
              ...
              <button
                ...
                onMouseLeave={e => {
                  e.currentTarget.style.boxShadow = '0 0 20px rgba(13,110,253,0.4)'
